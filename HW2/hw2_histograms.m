...
% Compute the histogram
 ...
 h_nbin=100; %number of bins for the histogram plot

 subplot(2,2,3);
 h1 = histogram2(A1,A2,h_nbin,'DisplayStyle','tile','ShowEmptyBins','on','EdgeColor','none');
 ...
 subplot(2,2,3);
 h2 = histogram2(A1,P,h_nbin,'DisplayStyle','tile','ShowEmptyBins','on','EdgeColor','none');
 ...
 subplot(2,2,3);
 h3 = histogram2(A2,P,h_nbin,'DisplayStyle','tile','ShowEmptyBins','on','EdgeColor','none');
